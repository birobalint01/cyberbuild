...
function Register() {
  ...
  return (
    <div style={{backgroundImage: `url(${require('./images/hatter.jpg')})`, height: '100vh' , backgroundRepeat: 'no-repeat' , backgroundSize: 'cover  '}}>
      <h1 className='asd' style={{marginBottom:'30px'}}>Regisztráció</h1>
      <form onSubmit={handleSubmit} className="asd">
        <label className='asd2' htmlFor="name">Név</label>
        ...
        <label className='asd2' htmlFor="repeatPassword">Jelszó ismét</label>
        ...
        <button type="submit" style={{marginTop:'15px'}}>Regisztráció</button>
        <Link to='/login' style={{marginTop:'30px'}}>Már van felhasználói Fiókja? Jelentkezzen be itt!</Link>
      </form>
    </div>
  );
}
